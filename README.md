...
This repository contains a script (Microsoft.PowerShell_profile.ps1) for PowerShell functions and aliases to make running Laravel Artisan commands faster and more convenient, especially for Windows users. Instead of typing php artisan, you can use a short alias like art or specific functions.

## Features
- **Single Alias**: Use a short alias (e.g., art) in place of php artisan.
...
- **Batch operations**: Combined cleanup and optimization commands
